.PHONY: cli-build cli-test cli-clean claude-message-build claude-message-test claude-message-clean npm-auth-check publish unpublish release publish-agent-message publish-codex-message publish-claude-message
